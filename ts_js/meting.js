...
class o extends r {
    ...
    format(t) {
        const e = t.filename || t.fileName,
            ...
            i = e.split(" - ");
        return i.length >= 2 && (r.artist = i[0].split("、"), r.name = i[1]), r
    }
    async handleDecode(t, e) {
...
module.exports = class {
    ...
    async _curl(e, r = null, i = !1) {
        ...
        r && ("object" != typeof r || Buffer.isBuffer(r) || "string" == typeof r || (r = new t.URLSearchParams(r).toString(), a.headers["Content-Type"] = "application/x-www-form-urlencoded"), a.body = r);
